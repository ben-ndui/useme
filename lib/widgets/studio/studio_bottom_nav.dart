...
/// Glass morphism bottom nav for Studio (mobile only)
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MessagingBloc, MessagingState>(
      buildWhen: (previous, current) {
        final prevCount =
            previous is ConversationsLoadedState ? previous.totalUnreadCount : 0;
        final currCount =
            current is ConversationsLoadedState ? current.totalUnreadCount : 0;
